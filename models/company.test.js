...
describe("findAll", () => {
  ...
  test("throws: when minEmployees greater than maxEmployees", async () => {
    await expect(
      Company.findAll({
        minEmployees: "3",
        maxEmployees: "2",
  ...
  test("throws: when minEmployees is not a valid number", async () => {
    await expect(
      Company.findAll({
        minEmployees: "abc",
      })
  ...
  test("throws: when maxEmployees is not a valid number", async () => {
    await expect(
      Company.findAll({
        maxEmployees: "abc",
      })
